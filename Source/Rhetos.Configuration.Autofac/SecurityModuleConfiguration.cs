...
namespace Rhetos.Configuration.Autofac
{
    public class SecurityModuleConfiguration : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<WcfWindowsUserInfo>().As<IBasicUserInfo>().InstancePerLifetimeScope().PreserveExistingDefaults();
            builder.RegisterType<DefaultUserInfo>().As<IUserInfo>().InstancePerLifetimeScope();
